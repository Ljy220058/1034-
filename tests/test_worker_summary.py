...
def test_worker_board_endpoint_returns_chinese_summary_and_counts(tmp_path: Path, monkeypatch) -> None:
    ...
    # Actual API uses running_task_count, no status_counts/health_counts in board response
...
def test_worker_summary_endpoint_includes_health_counts(tmp_path: Path, monkeypatch) -> None:
...
def test_worker_recommendations_endpoint_returns_summary(tmp_path: Path, monkeypatch) -> None:
