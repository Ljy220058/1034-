-- 迁移：添加活动参与率分析索引与状态视图
-- 日期：2026-06-06
-- 回滚：执行 migrations/004_activity_participation_indexes_and_view.rollback.sql
...
INSERT OR IGNORE INTO schema_migrations (version, name) VALUES (4, '004_activity_participation_indexes_and_view');
